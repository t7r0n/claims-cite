...
Solva gets a local, deterministic pressure test around solva, wedge, and recommendation. The useful part is not the dashboard; it is the repeatable evidence path from fixture to failure to operator action.
